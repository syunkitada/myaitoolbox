      ...
      className={cn(
        ...
        fullscreen
          ? isMobile
            ...
            : 'fixed inset-y-0 right-0 z-50 h-svh bg-background'
          : 'relative z-40 bg-background',
        className,
      )}
      style={
        isMobile && keyboard && !maximized
          ? { top: keyboard.top, left: 0, width: '100%', height: keyboard.height }
          : fullscreen && !isMobile
            ? { left: `var(--${sidebarCollapsed ? 'sidebar-width-icon' : 'sidebar-width'})` }
            : undefined
      }
    >
      <div
