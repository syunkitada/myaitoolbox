...
describe('resolveLinkTarget', () => {
  ...
  it('resolves markdown link targets via basename', () => {
...
describe('parseMarkdownLinks', () => {
  ...
  it('extracts markdown links', () => {
    const content = '[guide](./docs/guide.md) and [phase 1](./knowledge/phase1.md) and [[missing]]'
  ...
  it('skips self references and duplicates', () => {
    const content = '[README](./README.md) and [README again](./README.md) and [self](./README.md)'
...
describe('buildProjection', () => {
  ...
  it('creates external nodes for references to hidden markdown files', () => {
    ...
    const contents = new Map([
      ['README.md', '- links to [Phase 1](./knowledge/phase1.md) and [guide](./docs/guide.md)\n'],
    ])
  ...
  it('reuses visible file nodes when target is expanded', () => {
    ...
    state.expandedNodeIds.add(dirId('docs'))
    const contents = new Map([['README.md', '[Phase 1](./knowledge/phase1.md) and [guide](./docs/guide.md)\n']])
    const projection = buildProjection({ tree, state, contents, linkContext: ctx })
    const ids = new Set(projection.nodes.map((n) => n.id))
